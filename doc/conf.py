# -*- coding: utf-8 -*-
#
# moastro documentation build configuration file, created by
...
latex_documents = [
  ('index', 'moastro.tex', u'moastro Documentation',
   u'Jonathan Sick and Daniel Foreman-Mackey', 'manual'),
]
...
man_pages = [
    ('index', 'moastro', u'moastro Documentation',
     [u'Jonathan Sick and Daniel Foreman-Mackey'], 1)
]
